...
public class OpengaussConnection extends JdbcConnection {
     ...
     */
    public OpengaussConnection(JdbcConfiguration config, PostgresValueConverterBuilder valueConverterBuilder) {
        super(config, FACTORY, OpengaussConnection::validateServerVersion, null, "\"", "\"");
    ...
    public OpengaussConnection(OpengaussConnectorConfig config, TypeRegistry typeRegistry) {
        super(config.getJdbcConfig(), FACTORY, OpengaussConnection::validateServerVersion, null, "\"", "\"");

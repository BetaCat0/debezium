...
public class OpengaussOffsetContext extends CommonOffsetContext<SourceInfo> {
    private static final Logger LOGGER = LoggerFactory.getLogger(OpengaussOffsetContext.class);
    ...
    private OpengaussOffsetContext(OpengaussConnectorConfig connectorConfig, Lsn lsn, Lsn lastCompletelyProcessedLsn, Lsn lastCommitLsn, Long txId,
                                   ReplicationMessage.Operation messageType,
                                   Instant time,
                                   boolean snapshot,
    ...
    public static class Loader implements OffsetContext.Loader<OpengaussOffsetContext> {

        private final OpengaussConnectorConfig connectorConfig;

        public Loader(OpengaussConnectorConfig connectorConfig) {
        ...
        public OpengaussOffsetContext load(Map<String, ?> offset) {
            ...
            final ReplicationMessage.Operation messageType = msgType == null ? null : ReplicationMessage.Operation.valueOf(msgType);
            ...
            return new OpengaussOffsetContext(connectorConfig, lsn, lastCompletelyProcessedLsn, lastCommitLsn, txId, messageType, useconds, snapshot, lastSnapshotRecord,
    ...
    public String toString() {
        return "OpengaussOffsetContext [sourceInfoSchema=" + sourceInfoSchema + ", sourceInfo=" + sourceInfo

...
public class WalPositionLocator {
    ...
    public WalPositionLocator(Lsn lastCommitStoredLsn, Lsn lastEventStoredLsn, ReplicationMessage.Operation messageType) {
        this.lastCommitStoredLsn = lastCommitStoredLsn;
        this.lastEventStoredLsn = lastEventStoredLsn;
        this.lastProcessedMessageType = messageType;
    ...
    public Optional<Lsn> resumeFromLsn(Lsn currentLsn, ReplicationMessage message) {
        ...
        if (storeLsnAfterLastEventStoredLsn) {
            ...
            if (currentLsn.equals(lastEventStoredLsn)) {
                ...
                if (txStartLsn != null
                        && (lastProcessedMessageType == null || lastProcessedMessageType == ReplicationMessage.Operation.BEGIN
                                || lastProcessedMessageType == ReplicationMessage.Operation.COMMIT)) {

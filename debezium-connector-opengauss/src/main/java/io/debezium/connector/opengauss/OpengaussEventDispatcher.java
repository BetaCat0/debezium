...
import io.debezium.connector.opengauss.pipeline.txmetadata.OpengaussTransactionMonitor;
...
public class OpengaussEventDispatcher<T extends DataCollectionId> extends EventDispatcher<OpengaussPartition, T> {
    ...
    public OpengaussEventDispatcher(OpengaussConnectorConfig connectorConfig, TopicNamingStrategy<T> topicNamingStrategy,
        ...
        super(connectorConfig, topicNamingStrategy, schema, queue, filter, changeEventCreator, inconsistentSchemaHandler, heartbeat, schemaNameAdjuster,
                new OpengaussTransactionMonitor(
                        connectorConfig,
                        metadataProvider,
                        schemaNameAdjuster,

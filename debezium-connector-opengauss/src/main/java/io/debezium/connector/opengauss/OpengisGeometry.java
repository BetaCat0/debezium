...
public class OpengisGeometry {
     ...
     *
     * @return a {@link OpengisGeometry} which represents a PostgisGeometry API
     */
    public static OpengisGeometry createEmpty() {
        return OpengisGeometry.fromHexEwkb(HEXEWKB_EMPTY_GEOMETRYCOLLECTION);
    }

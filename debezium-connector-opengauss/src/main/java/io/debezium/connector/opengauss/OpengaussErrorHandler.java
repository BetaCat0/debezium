...
public class OpengaussErrorHandler extends ErrorHandler {
    ...
    public OpengaussErrorHandler(OpengaussConnectorConfig connectorConfig, ChangeEventQueue<?> queue, ErrorHandler replacedErrorHandler) {
        super(OpengaussConnector.class, connectorConfig, queue, replacedErrorHandler);
    }

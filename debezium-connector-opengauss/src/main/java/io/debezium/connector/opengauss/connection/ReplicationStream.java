...
public interface ReplicationStream extends AutoCloseable {
     ...
     */
    void read(ReplicationMessageProcessor processor) throws SQLException, InterruptedException, JsonProcessingException;
     ...
     */
    boolean readPending(ReplicationMessageProcessor processor) throws SQLException, InterruptedException, JsonProcessingException;
     ...
     * are read via the {@link ReplicationConnection#startStreaming(WalPositionLocator)} or {@link ReplicationConnection#startStreaming(Lsn, WalPositionLocator)}
     * methods.
     *

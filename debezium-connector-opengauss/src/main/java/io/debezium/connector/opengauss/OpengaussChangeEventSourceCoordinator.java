...
public class OpengaussChangeEventSourceCoordinator extends ChangeEventSourceCoordinator<OpengaussPartition, OpengaussOffsetContext> {
    ...
    public OpengaussChangeEventSourceCoordinator(Offsets<OpengaussPartition, OpengaussOffsetContext> previousOffsets,
                                                 ...
                                                 ChangeEventSourceMetricsFactory<OpengaussPartition> changeEventSourceMetricsFactory,
                                                 EventDispatcher<OpengaussPartition, ?> eventDispatcher, DatabaseSchema<?> schema,
                                                 SnapshotterService snapshotterService, SlotState slotInfo,
                                                 SignalProcessor<OpengaussPartition, OpengaussOffsetContext> signalProcessor,

...
public class OpengaussType {
    ...
    private final OpengaussType parentType;
    private final OpengaussType elementType;
    ...
    private OpengaussType(String name, int oid, int jdbcId, int modifiers, TypeInfo typeInfo, List<String> enumValues, OpengaussType parentType,
    ...
    public boolean equals(Object obj) {
        ...
        OpengaussType other = (OpengaussType) obj;
        if (oid != other.oid) {
            return false;
        }
        return true;
    ...
    public static class Builder {
        ...
        public OpengaussType build() {
            OpengaussType parentType = null;
            if (this.hasParentType()) {
                parentType = typeRegistry.get(parentTypeOid);
            }

            OpengaussType elementType = null;
            if (elementTypeOid != 0) {

...
public class Filters {
    ...
    protected static final List<String> SYSTEM_SCHEMAS = Arrays.asList(
            ...
            "db4ai", "dbe_perf", "sqladvisor", "dbe_pldebugger", "dbe_pldeveloper",
            "cstore", "blockchain", "pkg_service", "snapshot", "dbe_sql_util");
     ...
     */
    public Filters(OpengaussConnectorConfig config) {

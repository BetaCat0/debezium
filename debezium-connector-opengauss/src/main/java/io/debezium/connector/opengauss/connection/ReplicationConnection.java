...
public interface ReplicationConnection extends AutoCloseable {
     ...
     *
     * @param config a {@link OpengaussConnectorConfig} instance; may not be null
     * @return a builder, never null
     */
    static Builder builder(OpengaussConnectorConfig config) {
        return new OpengaussReplicationConnection.ReplicationConnectionBuilder(config);
    }
     ...
     *               is {@code null} or negative, this behaves exactly like {@link #startStreaming(WalPositionLocator)}.
     * @return a {@link PGReplicationStream} from which data is read; never null
    ...
    interface Builder {
         ...
         * @return this instance
         * @see #OpengaussConnectorConfig.AutoCreateMode.ALL_TABLES
         */
        Builder withPublicationAutocreateMode(OpengaussConnectorConfig.AutoCreateMode publicationAutocreateMode);

        /**
         * Sets the instance for the PG logical decoding plugin
         *
         * @param plugin the plugin instance, may not be null.
         * @return this instance
         * @see OpengaussConnectorConfig.LogicalDecoder
         */
        Builder withPlugin(OpengaussConnectorConfig.LogicalDecoder plugin);
         ...
         * @return this instance
         */
        Builder withSchema(OpengaussSchema schema);
         ...
         * @return
         */
        Builder jdbcMetadataConnection(OpengaussConnection jdbcConnection);

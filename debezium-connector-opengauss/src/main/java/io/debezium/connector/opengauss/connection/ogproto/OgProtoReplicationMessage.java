 ...
 */
class OgProtoReplicationMessage implements ReplicationMessage {

    private final PgProto.RowMessage rawMessage;
    private final TypeRegistry typeRegistry;

    public OgProtoReplicationMessage(PgProto.RowMessage rawMessage, TypeRegistry typeRegistry) {
    ...
    public Object getValue(String columnName, OpengaussType type, String fullType, PgProto.DatumMessage datumMessage,

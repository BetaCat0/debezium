...
public abstract class AbstractMessageDecoder implements MessageDecoder {
    ...
    @Override
    public void processMessage(ByteBuffer buffer, ReplicationMessageProcessor processor, TypeRegistry typeRegistry) throws SQLException, InterruptedException, JsonProcessingException {

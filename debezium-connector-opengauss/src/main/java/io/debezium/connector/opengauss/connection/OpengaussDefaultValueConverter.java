 ...
 */
@ThreadSafe
public class OpengaussDefaultValueConverter implements DefaultValueConverter {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(OpengaussDefaultValueConverter.class);
    private final OpengaussValueConverter valueConverters;
    private final Map<String, DefaultValueMapper> defaultValueMappers;

    public OpengaussDefaultValueConverter(OpengaussValueConverter valueConverters, TimestampUtils timestampUtils) {

...
import io.debezium.connector.opengauss.snapshot.query.SelectAllSnapshotQuery;
...
public class CustomTestSnapshot extends SelectAllSnapshotQuery implements Snapshotter, BeanRegistryAware {
    ...
    public void injectBeanRegistry(BeanRegistry beanRegistry) {
        ...
        Offsets<OpengaussPartition, OpengaussOffsetContext> postgresoffsets = beanRegistry.lookupByName(StandardBeanNames.OFFSETS, Offsets.class);

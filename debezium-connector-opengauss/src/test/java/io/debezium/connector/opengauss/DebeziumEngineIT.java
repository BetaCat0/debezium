...
public class DebeziumEngineIT {
    ...
    public void before() throws SQLException {
        ...
        TestHelper.execute("INSERT INTO engine.test VALUES(1, 'value1');");
    }
    ...
    public void shouldSerializeToJson() throws Exception {
        ...
        props.setProperty("connector.class", "io.debezium.connector.opengauss.OpengaussConnector");
        props.setProperty(StandaloneConfig.OFFSET_STORAGE_FILE_FILENAME_CONFIG,
                OFFSET_STORE_PATH.toAbsolutePath().toString());
        props.setProperty("offset.flush.interval.ms", "0");
        props.setProperty("converter.schemas.enable", "false");
        props.setProperty("schema.include.list", "engine");
        props.setProperty("table.include.list", "engine.test");
    ...
    public void testOffsetsCommitAfterStop() throws Exception {
        ...
        TestHelper.execute("DROP TABLE IF EXISTS engine.tests;", "CREATE TABLE engine.tests (id SERIAL PRIMARY KEY);");
        ...
        props.setProperty("schema.include.list", "engine");
        props.setProperty("table.include.list", "engine.*");
        ...
        while (offsetStoreSetCalls.get() < 1) {
            TestHelper.execute("INSERT INTO engine.tests VALUES(default)");
        }
        engine.close();

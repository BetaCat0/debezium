...
/**
 * Integration test for {@link OpengaussConnector} using an {@link EmbeddedEngine} and Testcontainers infrastructure for when Postgres is shutdown during streaming
 */
public class OpengaussShutdownIT extends AbstractConnectorTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OpengaussShutdownIT.class);

    private static final String POSTGRES_IMAGE = ContainerImageVersions.getStableImage("quay.io/debezium/example-opengauss");
    ...
    public void shouldStopOnPostgresFastShutdown() throws Exception {
        ...
        OpengaussConnection postgresConnection = TestHelper.create();

...
/**
 * Integration test for {@link OpengaussConnection}
 *
 * @author Horia Chiorean (hchiorea@redhat.com)
 */
public class OpengaussConnectionIT {
    ...
    public void shouldDetectRunningConncurrentTxOnInit() throws Exception {
        ...
        try (OpengaussConnection blockingConnection = TestHelper.create("blocker")) {
    ...
    public void shouldSupportPG95RestartLsn() throws Exception {
        ...
        try (OpengaussConnection conn = buildPG95PGConn("pg95")) {
    ...
    private OpengaussConnection buildPG95PGConn(String name) {
        return new OpengaussConnection((JdbcConfiguration) TestHelper.defaultJdbcConfig().edit().with("ApplicationName", name).build()) {
            @Override

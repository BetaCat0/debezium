 ...
 */
public class OpengaussMetricsIT extends AbstractRecordsProducerTest {

    private static final Logger LOGGER = LoggerFactory.getLogger(OpengaussMetricsIT.class);
    ...
    public void testLifecycle() throws Exception {
        // start connector
        start(OpengaussConnector.class,
    ...
    public void oneRecordInQueue() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.NO_DATA)
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.TRUE)
                .with(OpengaussConnectorConfig.MAX_QUEUE_SIZE, 10)
                .with(OpengaussConnectorConfig.MAX_BATCH_SIZE, 1)
                .with(OpengaussConnectorConfig.POLL_INTERVAL_MS, 100L)
                .with(OpengaussConnectorConfig.MAX_QUEUE_SIZE_IN_BYTES, 10000L);
        start(OpengaussConnector.class, configBuilder.build(), loggingCompletion(), null, x -> {

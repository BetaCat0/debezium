...
public class DecoderDifferences {
    ...
    public static boolean singleLsnPerTransaction() {
        return TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON
                || TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON_RDS;
    }

    private static boolean wal2Json() {
        return TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON
                || TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON_RDS
                || TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON_STREAMING
                || TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.WAL2JSON_RDS_STREAMING;
    }

    private static boolean pgoutput() {
        return TestHelper.decoderPlugin() == OpengaussConnectorConfig.LogicalDecoder.PGOUTPUT;
    }

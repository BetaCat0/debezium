...
import io.debezium.connector.opengauss.snapshot.InitialOnlySnapshotter;
...
public class OpengaussConnectorIT extends AbstractConnectorTest {
    ...
    public void shouldNotStartWithInvalidSlotConfigAndUserRoles() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.NEVER)
        ...
        Configuration failingConfig = TestHelper.defaultConfig()
                ...
                .with(OpengaussConnectorConfig.DATABASE_CONFIG_PREFIX + JdbcConfiguration.PASSWORD, "failing")
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.NEVER)
                .with(OpengaussConnectorConfig.SLOT_NAME, ReplicationConnection.Builder.DEFAULT_SLOT_NAME)
                .build();
    ...
    public void shouldValidateConfiguration() throws Exception {
        ...
        assertConfigurationErrors(validatedConfig, OpengaussConnectorConfig.SERVER_NAME, 1);

        // validate the non required fields
        validateConfigField(validatedConfig, OpengaussConnectorConfig.PLUGIN_NAME, OpengaussConnectorConfig.LogicalDecoder.DECODERBUFS.getValue());
        ...
        validateConfigField(validatedConfig, OpengaussConnectorConfig.SCHEMA_WHITELIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.SCHEMA_INCLUDE_LIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.SCHEMA_BLACKLIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.SCHEMA_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.TABLE_WHITELIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.TABLE_INCLUDE_LIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.TABLE_BLACKLIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.TABLE_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.COLUMN_BLACKLIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.COLUMN_EXCLUDE_LIST, null);
        validateConfigField(validatedConfig, OpengaussConnectorConfig.COLUMN_WHITELIST, null);
    ...
    public void shouldConsumeMessagesFromSnapshotOld() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(OpengaussConnectorConfig.MAX_QUEUE_SIZE, recordCount / 2)
                .with(OpengaussConnectorConfig.MAX_BATCH_SIZE, 10)
                .with(OpengaussConnectorConfig.SCHEMA_WHITELIST, "s1");
        start(OpengaussConnector.class, configBuilder.build());
        assertConnectorIsRunning();
    ...
    public void shouldProduceEventsWhenSnapshotsAreNeverAllowed() throws InterruptedException {
        ...
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.NEVER.getValue())
    ...
    public void shouldTakeBlacklistFiltersIntoAccount() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.INITIAL.getValue())
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.TRUE)
                .with(OpengaussConnectorConfig.SCHEMA_BLACKLIST, "s2")
                .with(OpengaussConnectorConfig.TABLE_BLACKLIST, ".+b")
                .with(OpengaussConnectorConfig.COLUMN_BLACKLIST, ".+bb");
    ...
    public void shouldRemoveWhiteSpaceCharsOld() throws Exception {
        ...
        Configuration.Builder configBuilder = TestHelper.defaultConfig()
                ...
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.TRUE)
                .with(OpengaussConnectorConfig.SCHEMA_WHITELIST, "s1")
                .with(OpengaussConnectorConfig.TABLE_WHITELIST, tableWhitelistWithWhitespace);
    ...
    public void shouldAllowForCustomSnapshot() throws InterruptedException {
        ...
        Configuration config = TestHelper.defaultConfig()
                ...
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE_CLASS, CustomTestSnapshot.class.getName())
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.FALSE)
                .build();
        start(OpengaussConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void shouldAllowForExportedSnapshot() throws Exception {
        ...
        TestHelper.execute(SETUP_TABLES_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.EXPORTED.getValue())
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.FALSE)
                .build();
        start(OpengaussConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void shouldResumeStreamingFromSlotPositionForCustomSnapshot() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.CUSTOM.getValue())
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE_CLASS, CustomStartFromStreamingTestSnapshot.class.getName())
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.FALSE)
                .build();
        start(OpengaussConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void customSnapshotterSkipsTablesOnRestart() throws Exception {
        ...
        config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.CUSTOM.getValue())
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE_CLASS, CustomPartialTableTestSnapshot.class.getName())
                .with(OpengaussConnectorConfig.DROP_SLOT_ON_STOP, Boolean.FALSE)
                .build();
        start(OpengaussConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void testCustomSnapshotterSnapshotCompleteLifecycleHook() throws Exception {
        ...
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE, OpengaussConnectorConfig.SnapshotMode.CUSTOM.getValue())
                .with(OpengaussConnectorConfig.SNAPSHOT_MODE_CLASS, CustomLifecycleHookTestSnapshot.class.getName())
                .build();
        start(OpengaussConnector.class, config);
        assertConnectorIsRunning();
    ...
    public void shouldClearDatabaseWarnings() throws Exception {
        ...
        TestHelper.execute(INSERT_STMT);
        Configuration config = TestHelper.defaultConfig()
                .with(OpengaussConnectorConfig.POLL_INTERVAL_MS, "10")
                .build();
